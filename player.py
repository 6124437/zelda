...
class Player(Entity):
    def __init__(self,pos,groups,obstacle_sprites,create_attack,destroy_attack,create_magic):
        ...
        # stats
        self.stats = {'health':100, 'energy':99, 'attack':0,'magic':4,'speed':5}
        self.max_stats = {'health':300, 'energy':100, 'attack':100,'magic':100,'speed':100}
    ...
    def animate(self):
        ...
        # animate damage flicker TODO: use mask (other tutorial)
        if not self.vulnerable:
    ...
    def regenerate_energy(self):
        self.energy = min(self.energy + 0.1 * self.stats['magic'], self.stats['energy'])
