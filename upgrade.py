...
class Upgrade:
    def __init__(self,player):
        ...
        # item creation
        self.top_padding = self.display_surface.get_size()[1] * 0.1
        self.full_width = self.display_surface.get_size()[0]
        self.width  = self.full_width // (self.attribute_nr + 1)
        self.increment = (self.width // self.attribute_nr)
    ...
    def create_items(self):
        ...
        for i in range(self.attribute_nr):
            left = self.width * i + self.increment * (i+0.5)
            item = Item(left,self.top_padding,self.width,self.height,i,self.font)
    ...
    def display(self):
        ...
        for i, item in enumerate(self.item_list):
            ...
            value = self.player.get_value_by_index(i)
            max_value = self.max_values[i]
            cost = self.player.get_cost_by_index(i)
...
class Item:
    ...
    def display_bar(self,surface,value,max_value,selected):
        ...
        value_rect = pygame.Rect(top[0] - 15, bottom[1] - relative_number ,30, relative_number + 2)
